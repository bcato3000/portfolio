                        ...
                        react_1["default"].createElement("nav", { className: "portfolio-links" },
                            react_1["default"].createElement("ul", null,
                                react_1["default"].createElement("li", null,
                                    react_1["default"].createElement("a", { href: "/portfolio/Ben-Cato-resume.pdf", download: "Ben-Cato-resume" }, "Download Resume")),
                                react_1["default"].createElement("li", null,
...
System.register("reportWebVitals", [], function (exports_13, context_13) {
    "use strict";
    var reportWebVitals;
        ...
        execute: function () {
            reportWebVitals = function (onPerfEntry) {
                if (onPerfEntry && onPerfEntry instanceof Function) {
                    context_13["import"]('web-vitals').then(function (_a) {
            ...
            exports_13("default", reportWebVitals);
        }
    };
});
System.register("index", ["react", "react-dom/client", "./styles/styles.css", "App", "reportWebVitals"], function (exports_14, context_14) {
    "use strict";
    var react_10, client_1, App_1, reportWebVitals_1, root;
    ...
    return {
        setters: [
            ...
            function (reportWebVitals_1_1) {
                reportWebVitals_1 = reportWebVitals_1_1;
            }
        ],
        execute: function () {
            root = client_1["default"].createRoot(document.getElementById('root'));
            root.render(react_10["default"].createElement(react_10["default"].StrictMode, null,
                react_10["default"].createElement(App_1["default"], null)));
